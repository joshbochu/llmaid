...
| 4 | Hierarchy & planning (mindmap / gantt / git) | **in progress** (4.1 done) |
...
| 6.3 | Generated + metamorphic topology tests | **done** — 71 DAGs + 40 design-doc direction renders + 197 ordered tree shapes |
...
```text
4.2 gantt/timeline → 4.3 gitGraph
